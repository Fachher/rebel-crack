...
public class JrebelChange {
    ...
    public static void loadFirst() throws Exception {
        try (URLClassLoader urlClassLoader = new URLClassLoader(new URL[]{ClassLoader.getSystemClassLoader().getResource("jrebel6/jrebel.jar")})) {
            ...
            Class<?> aClass = urlClassLoader.loadClass("com.zeroturnaround.javarebel.eav");
            ...
            File parent = new File("C:/Users/xin/.IntelliJIdea2017.2/system/plugins-sandbox2/plugins/jr-ide-idea/lib/jrebel6");

            FileUtils.copyInputStreamToFile(new ByteArrayInputStream(classWriter.toByteArray()), new File(parent.getAbsolutePath() + File.separator + "eav.class"));
        }
    }
